        ...
        <div class="mz-col mz-recent-articles-col-'<?php echo $item->ID; ?>'"
          id="article-'<?php echo $item->ID; ?>'">
					...
					<div class="mz-recent-article-details-wrap">
						<h3 class="mz-recent-article-title"><?php echo $item->post_title; ?></h3>
						<p class="mz-recent-article-excerpt"><?php echo strip_tags( substr( $item->post_content, 0, 250 ) ).' ...'; ?></p>
						<div class="mz-inner-row">
							<div class="mz-recent-article-released-date"><?php echo date_format( date_create( $item->post_date ), 'M j, Y' ); ?></div>
