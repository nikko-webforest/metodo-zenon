...
<article id="page-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<section class="mz-section mz-section--coaches-profile-carousel">
		<div class="mz-section-01">
			<div class="mz-container">
						...
						<div class="carousel-cell">
							<div class="coach-img-wrap">
								<img class="coach-img mz-img"
									...
									src="<?php the_field('coach_profile_image'); ?>"
									width=""
									height=""/>
							</div>
							<div class="coach-details-wrap">
								<div class="coach-expertise"><?php the_field('coach_expertise'); ?></div>
								<div class="coach-name"><?php echo explode(' ', trim($post->post_title))[0]; ?></div>
							</div>
						</div>
						...
						<div class="carousel-cell">
							<div class="mz-row">
								...
								<div class="mz-col">
									...
									<?php if( get_field('coach_competitive_advantages') ) : ?>

										<div class="coach-competitive-advantages">
											<h5>
									...
									<?php if( get_field('coach_expertise_level_list') ) : ?>

										<div class="coach-expertise-level-list">

											<?php while( have_rows('coach_expertise_level_list') ) : ?>
												<?php the_row(); ?>

												<?php if( get_sub_field('health_coaching_level') ) : ?>
												
													<div class="coach-expertise-level-item">
														<div class="coach-expertise-level-details">
															<h6 class="coach-expertise-level-name"> Health Coaching </h6>
															<h6 class="coach-expertise-level-level"><?php the_sub_field('health_coaching_level'); ?>%</h6>
														</div>
														<progress class="coach-expertise-level-progress"
															value="<?php the_sub_field('health_coaching_level'); ?>"
															max="100">
														</progress>
													</div>
												...
												<?php if( get_sub_field('corrective_excercise_level') ) : ?>
												
													<div class="coach-expertise-level-item">
														<div class="coach-expertise-level-details">
															<h6 class="coach-expertise-level-name"> Corrective Excercise Level </h6>
															<h6 class="coach-expertise-level-level"><?php the_sub_field('corrective_excercise_level'); ?>%</h6>
														</div>
														<progress class="coach-expertise-level-progress"
															value="<?php the_sub_field('corrective_excercise_level'); ?>"
															max="100">
														</progress>
													</div>
												...
												<?php if( get_sub_field('weight_loss_transformation_level') ) : ?>
												
													<div class="coach-expertise-level-item">
														<div class="coach-expertise-level-details">
															<h6 class="coach-expertise-level-name"> Weight Loss Transformation Level </h6>
															<h6 class="coach-expertise-level-level"><?php the_sub_field('weight_loss_transformation_level'); ?>%</h6>
														</div>
														<progress class="coach-expertise-level-progress"
															value="<?php the_sub_field('weight_loss_transformation_level'); ?>"
															max="100">
														</progress>
													</div>
									...
									<?php if( get_field('coach_specialites_list') ) : ?>
										...
										<div class="coach-specialties-wrap">
											...
											<div class="coach-specialties-list">
												
												<?php while( have_rows('coach_specialites_list') ) : ?>
													<?php the_row(); ?>

													<?php if( get_sub_field('coach_specialites_item_01') ) : ?>

														<div class="coach-specialties-item">
															...
															<div class="coach-specialties-details">
																<?php the_sub_field('coach_specialites_item_01') ?>
															</div>
														</div>

													<?php endif; ?>

													<?php if( get_sub_field('coach_specialites_item_02') ) : ?>
														...
														<div class="coach-specialties-item">
															...
															<div class="coach-specialties-details">
																<?php the_sub_field('coach_specialites_item_02') ?>
															</div>
														</div>

													<?php endif; ?>

													<?php if( get_sub_field('coach_specialites_item_03') ) : ?>
														...
														<div class="coach-specialties-item">
															...
															<div class="coach-specialties-details">
																<?php the_sub_field('coach_specialites_item_03') ?>
															</div>
														</div>

													<?php endif; ?>

													<?php if( get_sub_field('coach_specialites_item_04') ) : ?>
														...
														<div class="coach-specialties-item">
															...
															<div class="coach-specialties-details">
																<?php the_sub_field('coach_specialites_item_04') ?>
															</div>
														</div>

													<?php endif; ?>

													<?php if( get_sub_field('coach_specialites_item_05') ) : ?>
														...
														<div class="coach-specialties-item">
															...
															<div class="coach-specialties-details">
																<?php the_sub_field('coach_specialites_item_05') ?>
															</div>
														</div>
