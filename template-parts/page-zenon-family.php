					...
					<div class="carousel-cell">
						<div class="coach-img-wrap">
							<img class="coach-img mz-img"
								alt="Coach Carlos"
								title="Coach Carlos"
								src="/wp-content/themes/metodo-zenon/images/mz-zenon-family-section/carousel-cell/MZ_ZenonFamilyPage_CoachCarlos.png"
								width=""
								height=""/>
						</div>
						<div class="coach-details-wrap">
							<div class="coach-type">Personal Trainer</div>
							<div class="coach-name">Carlos</div>
						</div>
					</div>
					<div class="carousel-cell">
						<div class="coach-img-wrap">
						...
						<div class="coach-details-wrap">
							<div class="coach-type">Health Psychologist</div>
					...
					<div class="carousel-cell">
						<div class="coach-img-wrap">
							<img class="coach-img mz-img"
								alt="Coach Rodrigo"
								title="Coach Rodrigo"
								src="/wp-content/themes/metodo-zenon/images/mz-zenon-family-section/carousel-cell/MZ_ZenonFamilyPage_CoachRodrigo.png"
								width=""
								height=""/>
						</div>
						<div class="coach-details-wrap">
							<div class="coach-type">Physiotherapist</div>
							<div class="coach-name">Rodrigo</div>
						</div>
					</div>
					<div class="carousel-cell">
						<div class="coach-img-wrap">
						...
						<div class="coach-details-wrap">
							<div class="coach-type">Physical Trainer</div>
						...
						<div class="mz-row">
							<div class="mz-col">
								<img class="coach-img mz-img"
									alt="Coach Carlos"
									title="Coach Carlos"
									src="/wp-content/themes/metodo-zenon/images/mz-zenon-family-section/carousel-content/MZ_ZenonFamilyPage_CoachCarlos.png"
									width=""
									height=""/>	
								<div class="mz-details">
									<h3>Carlos Del Río</h3>
					...
					<div class="carousel-cell">
						...
						<div class="mz-col">
							<img class="coach-img mz-img"
								alt="Coach Rodrigo"
								title="Coach Rodrigo"
								src="/wp-content/themes/metodo-zenon/images/mz-zenon-family-section/carousel-content/MZ_ZenonFamilyPage_CoachRodrigo.png"
								width=""
								height=""/>	
							<div class="mz-details">
								<h3>Rodrigo De Anta</h3>
					...
					<div class="carousel-cell">
						...
						<div class="mz-col">
							<img class="coach-img mz-img"
								alt="Coach Alvaro"
								title="Coach Alvaro"
								src="/wp-content/themes/metodo-zenon/images/mz-zenon-family-section/carousel-content/MZ_ZenonFamilyPage_CoachAlvaro.png"
								width=""
								height=""/>	
							<div class="mz-details">
								<h3>Álvaro De Pedro</h3>
								<h6>Physical Trainer</h6>
								<p>
									Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
								</p>
								<div class="mz-socials">
